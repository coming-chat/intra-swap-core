...
func (_ISwapRouter *ISwapRouterCaller) WETH9(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ISwapRouter.contract.Call(opts, &out, "WETH9")
...
//
// Solidity: function WETH9() view returns(address)
func (_ISwapRouter *ISwapRouterSession) WETH9() (common.Address, error) {
	return _ISwapRouter.Contract.WETH9(&_ISwapRouter.CallOpts)
}

// WETH9 is a free data retrieval call binding the contract method 0x4aa4a4fc.
//
// Solidity: function WETH9() view returns(address)
func (_ISwapRouter *ISwapRouterCallerSession) WETH9() (common.Address, error) {
	return _ISwapRouter.Contract.WETH9(&_ISwapRouter.CallOpts)
}
