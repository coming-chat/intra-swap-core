...
func (h *HeuristicGasModelFactory) BuildGasModel(
...
) (gasModel providers.GasModel[providers.V3RouteWithValidQuote], err error) {
	...
	gasModel.CalculateL1GasFeesFn = func(routes []providers.V3RouteWithValidQuote) (*providers.L1ToL2GasCosts, error) {
		...
		return &providers.L1ToL2GasCosts{
			GasUsedL1:           l1Used,
	...
	nativeCurrency := base_entities.WRAPPED_NATIVE_CURRENCY[chainId]
	if token.Equal(nativeCurrency) {
		gasModel.EstimateGasCostFn = func(routeWithValidQuote providers.V3RouteWithValidQuote) (
			gasEstimate *big.Int,
	...
	gasModel.EstimateGasCostFn = func(routeWithValidQuote providers.V3RouteWithValidQuote) (gasEstimate *big.Int, gasCostInToken, gasCostInUSD *entities.CurrencyAmount, err error) {
		totalGasCostNativeCurrency, _, baseGasUse, err := h.estimateGas(routeWithValidQuote, gasPriceWei, chainId)
		if err != nil {
			return nil, nil, nil, err
		}
...
func (h *HeuristicGasModelFactory) getHighestLiquidityUSDPool(
	...
	usdTokens, ok := gas_models.UsdGasTokensByChain[chainId]
	if !ok {
...
func (h *HeuristicGasModelFactory) calculateOptimismToL1SecurityFee(
	routes []providers.V3RouteWithValidQuote,
...
func (h *HeuristicGasModelFactory) estimateGas(
	routeWithValidQuote providers.V3RouteWithValidQuote,
	gasPriceWei *big.Int,
	chainId base_entities.ChainId,
