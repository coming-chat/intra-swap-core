...
func (h *HeuristicGasModelFactory) BuildGasModel(
...
) (gasModel providers.GasModel[providers.V2RouteWithValidQuote], err error) {
	...
	if token.Equal(wrappedNativeCurrency) {
		...
		gasModel.EstimateGasCostFn = func(routeWithValidQuote providers.V2RouteWithValidQuote) (
			*big.Int,
...
func (h *HeuristicGasModelFactory) estimateGas(
	routeWithValidQuote providers.V2RouteWithValidQuote,
	gasPriceWei *big.Int,
	chainId base_entities.ChainId,
